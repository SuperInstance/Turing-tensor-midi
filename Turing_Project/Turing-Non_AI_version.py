...
#He's named JARVIS, no changes to that to preserve original design and idea 
...
def startup():
    ...
    say(f"{greeting}, sir. The time is {c_time}. I am Jarvis, online and fully operational.")
...
def main():
    ...
    while True:
        ...
        sites = [
            ...
            ["nike run club", "https://www.nike.com/running/nrc-app"],
            ...
            ["kraft recipes", "https://www.kraftrecipes.com"],
            ["campbell's kitchen", "https://www.campbells.com/kitchen/"],
            ...
            ["upfront ventures", "https://www.upfront.com"],
